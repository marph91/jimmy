...
class Converter(converter.BaseConverter):
    ...
    def convert_note(self, file_: Path, parent: imf.Notebook):
        ...
        note_imf.body = src.jimmy.md_lib.convert.markup_to_markdown(
            ...
            custom_filter=[
                src.jimmy.md_lib.html_filter.nimbus_note_add_mark,
                src.jimmy.md_lib.html_filter.nimbus_note_add_note_links,
                src.jimmy.md_lib.html_filter.nimbus_note_streamline_lists,
                src.jimmy.md_lib.html_filter.nimbus_note_streamline_tables,
                src.jimmy.md_lib.html_filter.nimbus_strip_images,
            ],
        ).strip()
